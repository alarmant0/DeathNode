...
/**
 * Command-line interface for DeathNode secure document operations.
 * 
 * Usage:
 *   deathnode help
 *   deathnode protect <input-file> <key-name> <output-file>
 *   deathnode check <input-file> <key-name>
 *   deathnode unprotect <input-file> <key-name> <output-file>
 *   deathnode genkeys <user-id>
 */
